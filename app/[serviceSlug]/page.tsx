...
export default function DynamicServicePage() {
  ...
  const aboutDesc = serviceData?.aboutDesc || `At Arvian Business Solutions, we create tailored growth roadmaps for every seller. With 8+ years of marketplace experience, our team of dedicated managers will help you rank higher, lower your ACOS, and achieve continuous month-over-month revenue growth.`;
  ...
  const faqs = serviceData?.faqs || [
    {
      question: `How does Arvian deliver results for ${formattedTitle}?`,
  ...
  return (
    <>
      ...
      <main className="min-h-screen pt-20">
        ...
        {/* HERO SECTION */}
        <section className="relative py-16 lg:py-24 bg-gradient-to-b from-[#FFFFED] via-white to-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  ...
                  <a
                    href={`tel:${content.branding.topbarPhone || '+9118008901413'}`}
                    className="px-8 py-4 rounded-full bg-white border border-gray-300 text-gray-800 font-bold text-sm hover:bg-gray-50 transition-colors"
                  >
                    Call: {content.branding.tollFreePhone || '1800 890 1413'}
                  </a>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <div className="pt-2">
                  <button
                    onClick={() => setPopupOpen(true)}
                    className="inline-flex items-center gap-2 text-sm font-bold text-[#f71735] hover:underline"
                  >
        ...
        {advantages.length > 0 && (
          <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-3xl mx-auto mb-16">
                <span className="text-xs uppercase font-bold text-[#f71735] tracking-widest">Why Arvian</span>
                <h2 className="text-3xl sm:text-4xl font-black text-gray-900 mt-2">
                  The Arvian Growth Advantage
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {advantages.map((adv: any) => (
                  <div
                    key={adv.title}
                    className="p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-xs hover:shadow-md transition-all flex items-start gap-4"
                  >
                    {adv.icon && (
                      <div className="w-12 h-12 flex-shrink-0 bg-white rounded-xl flex items-center justify-center p-2 border border-gray-200">
