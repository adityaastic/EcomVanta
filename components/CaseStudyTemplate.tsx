  ...
  return (
    <>
      ...
      <main className="min-h-screen pt-20 bg-white">
        ...
        {/* HERO SECTION */}
        <section className="relative py-16 lg:py-24 bg-gradient-to-b from-[#FFFFED] via-white to-white border-b border-gray-100 overflow-hidden">
          <div className="absolute top-10 right-10 w-80 h-80 bg-red-400/10 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-10 w-80 h-80 bg-purple-400/10 rounded-full blur-3xl pointer-events-none" />

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            
            <Link
              href="/portfolio"
              className="inline-flex items-center gap-2 text-xs font-bold text-[#f71735] hover:underline mb-8"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-8 space-y-5">
                <div className="flex items-center gap-3">
                  <span className="px-3.5 py-1 rounded-full bg-red-50 text-[#f71735] text-xs font-bold uppercase tracking-wider">
                    {data.category}
                  </span>
                ...
                <div className="pt-2 flex flex-wrap gap-4">
                  <button
                    ...
                    className="arvianPulseBtn px-8 py-4 rounded-full bg-[#f71735] text-white font-bold text-sm hover:bg-[#cc0000] shadow-xl cursor-pointer transition-transform"
                  >
              ...
              <div className="lg:col-span-4 flex justify-center">
                <div className="p-8 rounded-3xl bg-white border border-gray-200 shadow-xl flex items-center justify-center aspect-square w-64 h-64 relative">
                  <Image
                    src={data.brandLogo}
                    alt={data.brandName}
                    width={180}
        ...
        <section className="py-16 bg-gray-50 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              <span className="text-xs uppercase font-bold text-[#f71735] tracking-widest">Growth Highlights</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {data.snapshot.map((snap) => (
                <div
                  key={snap.label}
                  className="p-6 rounded-2xl bg-white border border-gray-200 shadow-xs text-center"
                >
                  <p className="text-3xl sm:text-4xl font-black text-[#f71735]">{snap.metric}</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 space-y-4">
                <span className="text-xs uppercase font-bold text-[#f71735] tracking-widest">Obstacles Faced</span>
                <h2 className="text-3xl sm:text-4xl font-black text-gray-900 leading-tight">
                  {data.challengeTitle}
                </h2>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Before partnering with Arvian Business Solutions, {data.brandName} faced critical hurdles in scaling their online marketplace presence.
                </p>
              </div>
              ...
              <div className="lg:col-span-7 space-y-4">
                {data.challenges.map((chal, idx) => (
                  ...
                  >
                    <span className="w-8 h-8 rounded-full bg-red-100 text-[#f71735] font-black text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                      0{idx + 1}
                    </span>
        ...
        {/* THE ARVIAN SOLUTION (6 STEPS) */}
        <section className="py-20 bg-gray-50 border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-xs uppercase font-bold text-[#f71735] tracking-widest">Our Playbook</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {data.solutions.map((sol) => (
                <div
                  key={sol.title}
                  className="p-8 rounded-3xl bg-white border border-gray-200 hover:border-[#f71735]/40 shadow-xs hover:shadow-xl transition-all flex flex-col justify-between"
                >
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-red-50 flex items-center justify-center p-2.5 mb-6">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="text-xs uppercase font-bold text-[#f71735] tracking-widest">Documented Growth</span>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <span className="p-4 bg-[#f71735] text-white rounded-full shadow-2xl">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-6 space-y-4">
                  <span className="text-xs uppercase font-bold text-[#f71735] tracking-widest">Catalog Optimization</span>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-gray-950 to-[#0A0A24] text-white shadow-2xl text-center relative overflow-hidden">
              <Quote className="w-12 h-12 text-[#f71735]/40 mx-auto mb-4" />
              ...
              <div className="mt-6 pt-4 border-t border-white/10">
                ...
                <p className="text-xs text-[#f71735] font-semibold">{data.testimonial.designation}</p>
              </div>
            </div>
          </div>
        </section>
