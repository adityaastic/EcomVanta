...
export const CASE_STUDIES_DATA: Record<string, CaseStudyData> = {
  'kay-kay-industries-amazon-case-study': {
    ...
    testimonial: {
      quote: 'EcomVanta completely revolutionized our Amazon seller account. Our sales quadrupled while our ad expenses were cut in half.',
  ...
  'gataca-performance-supplements-amazon-case-study': {
    ...
    subtitle: 'Scaling an Indian sports nutrition brand from scratch to market leadership with Amazon PPC & brand storefront.',
    snapshot: [
      { metric: '10X', label: 'Order Growth', sublabel: 'From 500 to 5,000+ units/mo' },
      { metric: '4.2X', label: 'Average ROAS', sublabel: 'High-intent PPC campaigns' },
      { metric: '20%+', label: 'Repeat Customers', sublabel: 'Via Subscribe & Save' },
      { metric: 'Top 3', label: 'Category Ranking', sublabel: 'In Whey & Pre-Workout' },
    ],
    challengeTitle: 'The Business Challenge',
    challenges: [
      'Extremely saturated sports nutrition category dominated by global imported brands.',
      'High Cost-Per-Click (CPC) making broad keyword PPC campaigns unprofitable.',
      'Customer skepticism regarding purity and authenticity of new Indian supplement brands.',
      'Low repeat purchase rate due to lack of customer retention funnel.',
    ],
    solutionTitle: 'Our Strategic Solution',
    solutions: [
      {
        icon: '/abt-img/Product Listing Optimization.png',
        title: 'Authenticity & Lab-Report A+ Content',
        desc: 'Designed transparent third-party lab test badges, ingredient origin charts, and informed-choice certifications.',
      },
      {
        icon: '/abt-img/Catalog Management.png',
        title: 'Flavor & Size Matrix Structuring',
        desc: 'Clean child variation theme grouping 1kg/2kg packs with 6 flavor choices into single parent ASINs.',
      },
      {
        icon: '/abt-img/Amazon Advertising.png',
        title: 'High-Intent Long-Tail PPC',
        desc: 'Targeted long-tail fitness queries ("isolate whey for muscle recovery") lowering CPC by 38%.',
      },
      {
        icon: '/abt-img/Performance Monitoring.png',
        title: 'Subscribe & Save Integration',
    ...
    testimonial: {
      quote: 'The team at EcomVanta understands e-commerce algorithms better than anyone. They positioned GATACA right alongside the biggest legacy brands in our category.',
      author: 'Founder & CEO',
  ...
  'sai-gallery-agarbatti-brand-amazon-case-study': {
    ...
    testimonial: {
      quote: 'EcomVanta took our traditional agarbatti business and built a thriving nationwide online brand. Their bundle strategy changed our unit economics completely.',
  ...
  'nut-o-nut-dry-fruits-brand-amazon-case-study': {
    ...
    subtitle: 'How EcomVanta achieved +185% organic search impressions, 99.8% FBA dispatch, and top category ranking on Amazon.',
    snapshot: [
    ...
    testimonial: {
      quote: 'EcomVanta’s operational precision and festive advertising strategies propelled Nut o Nut to become one of the top dry fruit sellers on Amazon India.',
      author: 'Co-Founder',
